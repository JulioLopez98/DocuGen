...
export default async function CatalogPage() {
  ...
  const schema = {
    ...
    url: `${process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000"}/catalogo`,
    hasPart: documentTypes.map((doc) => ({
      "@type": "WebPage",
      name: doc.label,
      url: `${process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000"}/${doc.type}`,
