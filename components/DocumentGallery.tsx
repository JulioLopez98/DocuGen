  ...
  return (
    <section className="container-page py-16">
      <div className="mb-8 max-w-3xl">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#2d6a4f]">Documentos</p>
        <h2 className="font-serif-display mt-3 text-4xl font-bold">Una galería pensada para trabajo real</h2>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {documentTypes.map((doc) => (
          <Link key={doc.type} href={`/${doc.type}`} className="rounded-md border border-[#d8f3dc] bg-white p-5">
