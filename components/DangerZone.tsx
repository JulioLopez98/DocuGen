...
export function DangerZone() {
  ...
  async function clearHistory() {
    ...
    try {
      ...
      setMessage("Historial borrado correctamente.");
      router.refresh();
    } catch {
  ...
  return (
    <section className="surface rounded-md p-6">
      ...
      <h2 className="font-serif-display mt-3 text-3xl font-bold">Historial</h2>
      ...
      >
        {loading ? "Borrando..." : "Borrar todo el historial"}
      </button>
